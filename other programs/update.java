...
public class update extends JPanel implements ActionListener,ItemListener
  {
...
public void actionPerformed(ActionEvent ae)
   ...
   st.executeUpdate("update Store set PID='"+str1+"',IMEI='"+str2+"',Company='"+str3+"',Model='"+str4+"',Serial='"+str5+"',Price='"+str6+"',GPRS='"+s7+"',DualSim='"+s8+"',Bluetooth='"+s9+"',3G='"+s10+"',QWERTY='"+s11+"',Multimedia='"+s12+"'where PID="+s);
